...
const ReciverMsg = (msg) => {
  ...
  return (
    <div className="w-fit sm:max-w-[500px] max-w-[300px] px-1 pb-1 pt-2 bg-gradient-to-br from-[#3e6bff] to-[#5ae6ff] rounded-tl-none rounded-2xl text-black mx-3 my-5 relative shadow-lg shadow-gray-500"
      ref={scroll} >
      {msg?.msg?.image && (
