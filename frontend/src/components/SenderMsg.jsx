...
const SenderMsg = (msg) => {
  ...
  return (
    <div className="w-fit sm:max-w-[500px] max-w-[300px] px-3 py-1 bg-gradient-to-br from-[#82ff51] to-[#00bc19] rounded-tr-none rounded-2xl text-black m-3 relative right-0 ml-auto shadow-lg shadow-gray-500" ref={scroll}>
      {msg?.msg?.image && (
        <img
          src={msg?.msg?.image}
